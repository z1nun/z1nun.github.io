...
export const SPOTS: Record<string, Spot> = {
  ...
  yehliu:     { cat: "trip",  ll: [25.2065, 121.6905], label: "예류지질공원", name: "🪨 예류지질공원", zh: "野柳地質公園", area: "신베이 완리", desc: "여왕머리 바위 — 보통 08:00~17:00. 바람 강하니 겉옷" },
  shifen:     { cat: "trip",  ll: [25.0412, 121.7757], label: "스펀",         name: "🎈 스펀 라오제", zh: "十分老街", area: "핑시선", desc: "기찻길 옆에서 천등 날리기 — 소원 4면에 쓰기. 근처 스펀폭포도" },
  jiufen:     { cat: "trip",  ll: [25.1097, 121.8443], label: "지우펀",       name: "🏮 지우펀 라오제", zh: "九份老街", area: "루이팡", desc: "홍등 골목 — 점등되는 해질녘(17시 전후)에 맞춰 도착. 땅콩 아이스크림롤·위위안" },
};
...
export const DAY_META: DayMeta[] = [
  ...
  { d: "Day 3", dt: "11/1 일",  note: "🚌 근교 데이 — 예류→스펀→지우펀 순서로, 지우펀은 해질녘 도착이 포인트. 셔틀투어/택시 대절 추천" },
...
export const DEFAULT_DAYS: string[][] = [
  ...
  ["yehliu", "shifen", "jiufen", "amei", "azong"],
